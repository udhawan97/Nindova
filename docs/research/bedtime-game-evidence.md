...
- Begin any efficacy or outcome research with consenting adults. [ADR 0013](../adr/0013-add-the-adult-nindova-house.md) supersedes the historical 13+ boundary with an adults-18+ product boundary; pediatric research would require separate evidence, consent, safeguarding, and age-appropriate testing.
