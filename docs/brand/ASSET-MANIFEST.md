...
All five public-media PNGs are regenerated by `npm run capture:public-media`, which builds the House and Night sources before capture. They are product evidence, not hand-composed marketing mockups.
