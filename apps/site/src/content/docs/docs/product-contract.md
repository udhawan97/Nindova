...
- Chandigarh: The Long Way Home is a five-encounter Sector 22 to Sector 17 outing with deliberate movement, route choice, a fictional scarf-deflection encounter, source-separated city notes and a complete narrated equivalent. Every timed or precision action has guided help. Its ten-minute foreground boundary suspends on pause/hide/blur/exit; unfinished closure records no completion, and detailed route state stays in memory. No scores, lives, random rewards, persistent collection or sleep claims. The Night Room is unchanged.
