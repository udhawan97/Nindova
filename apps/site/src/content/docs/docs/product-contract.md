...
- Sector Sprint is a fixed-route action table, not an endless runner. Automatic forward motion, variable leaps, air step, dash/vault/stomp movement, five Act-local harmless tools, and deterministic temporary effects cannot create a score, high score, timer, health, lives, failure, progress loss, randomized reward, persistent inventory, or claimed sleep effect. People, animals, vehicles, and buildings can never be targets. Its complete narrated route has the same entertainment provenance and curtain call. If the whole-table boundary arrives before every Act closes, the table exits without creating a Gallery completion.
