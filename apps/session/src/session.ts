...
function iconSvg(motif: RasoiMotifId) {
  ...
  const drawings: Record<RasoiMotifId, string> = {
    belan: '<g transform="rotate(-24 24 24)"><rect x="2" y="22" width="44" height="5" rx="2.5"/><rect x="10" y="18" width="28" height="13" rx="5"/><path d="M14 20h19M14 23h18" stroke="#f4dab0" stroke-width="1.5" stroke-linecap="round" opacity=".7"/><path d="M12 28h24" stroke="#39282c" opacity=".35"/></g>',
    chakla: '<ellipse cx="24" cy="28" rx="18" ry="15" opacity=".4"/><circle cx="24" cy="22" r="18"/><circle cx="24" cy="22" r="14" fill="none" stroke="#e5cc9d" stroke-width="1.2"/><circle cx="24" cy="22" r="10.5" fill="none" stroke="#e5cc9d" opacity=".4"/><path d="M15 15q9-7 18 2M14 25q10-5 19 2" stroke="#e5cc9d" fill="none" opacity=".35"/>',
    tawa: '<path d="m31 25 14 4-1 6-15-6Z"/><ellipse cx="20" cy="26" rx="16" ry="14" opacity=".55"/><ellipse cx="20" cy="23" rx="16" ry="14"/><ellipse cx="20" cy="22" rx="12" ry="10" stroke="#efd1a0" stroke-width="1.3" fill="none"/><path d="M11 20q6-8 15-3" stroke="#efd1a0" opacity=".55" fill="none" stroke-linecap="round"/>',
    chimta: '<g stroke="currentColor" stroke-width="4" stroke-linecap="round" fill="none"><path d="M24 9 13 39M24 9l11 30"/></g><circle cx="24" cy="8" r="5"/><circle cx="24" cy="8" r="2" fill="#f3dbb4"/><g stroke="#f3dbb4" stroke-width="1.2"><path d="m21 16-7 21M26 16l7 21M13 32l5 1M30 33l5-1"/></g>',
    katori: '<ellipse cx="24" cy="38" rx="12" ry="3" opacity=".23"/><path d="M6 20q2 18 18 18t18-18Z"/><ellipse cx="24" cy="20" rx="18" ry="6" fill="#d5b878" stroke="currentColor" stroke-width="2"/><ellipse cx="24" cy="20" rx="13" ry="3" fill="currentColor" opacity=".65"/><path d="M12 26q2 6 9 8" stroke="#fff0d0" stroke-width="2" stroke-linecap="round" fill="none" opacity=".7"/>',
    tiffin: '<path d="M18 13V8q0-3 6-3t6 3v5" stroke="currentColor" stroke-width="3" fill="none"/><rect x="10" y="12" width="28" height="29" rx="6"/><g stroke="#f5d7a4" stroke-width="1.8" fill="none"><path d="M11 20q13 5 26 0M11 29q13 5 26 0M15 16v20"/></g><ellipse cx="24" cy="13" rx="14" ry="4" fill="#d1b780" stroke="currentColor" stroke-width="2"/><path d="M7 15v22M41 15v22" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>',
    masala: '<ellipse cx="24" cy="27" rx="20" ry="17" opacity=".55"/><circle cx="24" cy="23" r="19"/><circle cx="24" cy="23" r="16.5" fill="#d8b67c"/> <g stroke="#7f643f" stroke-width="1.1"><circle cx="24" cy="23" r="4.5" fill="#944c37"/><circle cx="24" cy="12.5" r="4.5" fill="#cf933c"/><circle cx="33" cy="18" r="4.5" fill="#a05338"/><circle cx="33" cy="28.5" r="4.5" fill="#8d843e"/><circle cx="24" cy="33.5" r="4.5" fill="#af763f"/><circle cx="15" cy="28.5" r="4.5" fill="#6b7551"/><circle cx="15" cy="18" r="4.5" fill="#c4924d"/></g>',
    chai: '<ellipse cx="24" cy="41" rx="12" ry="3" opacity=".25"/><path d="M12 12h24l-4 27q-8 6-16 0Z"/><path d="M16 18h16l-3 19q-5 3-10 0Z" fill="#bd834e"/><ellipse cx="24" cy="13" rx="12" ry="4" fill="#edcca0"/><ellipse cx="24" cy="13" rx="9" ry="2.3" fill="#835638"/><path d="m16 18 2 16" stroke="#fff0ce" stroke-width="2" stroke-linecap="round" opacity=".8"/><path d="M22 8q-3-3 0-6M28 8q3-3 0-6" stroke="currentColor" fill="none" opacity=".6"/>',
    cooker: '<path d="M8 21h31v12q0 9-9 9H17q-9 0-9-9Z"/><rect x="3" y="21" width="8" height="6" rx="2"/><rect x="37" y="21" width="10" height="5" rx="2"/><path d="M7 17q17-15 33 0Z"/><rect x="5" y="16" width="36" height="4" rx="2"/><rect x="20" y="5" width="7" height="6" rx="2"/><path d="M13 24v8q0 5 6 5M14 15q8-5 15-2" stroke="#f1d8ad" stroke-width="2" stroke-linecap="round" fill="none" opacity=".7"/>',
  };
