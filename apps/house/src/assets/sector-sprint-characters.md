...
`sector-sprint-characters.png` is the original transparent runtime sprite sheet for Gurpreet and Harjit. The game slices it as five columns by two rows: thrust, glide, harmless tool pulse, comic impact, and landing. If it cannot load, the existing code-drawn lead remains playable.
